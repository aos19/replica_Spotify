  ...
  export const ItemList = ({ title, items, itemsArray, path, idPath }) => {
    ...
    const finalItems = isHome ? items : Infinity;
     ...
     // Verificação para evitar erro caso itemsArray não seja um array
  if (!Array.isArray(itemsArray)) {
    console.error("itemsArray não é um array!", itemsArray);
    return null; // ou pode retornar um fallback, tipo <p>Sem itens para mostrar</p>
  }
